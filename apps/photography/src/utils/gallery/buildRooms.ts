...
// Self-check lives in ./buildRooms.selfcheck.ts (run with tsx) — kept out of
// this module so no CJS `require`/`module` reference can leak into the client
// bundle that imports these helpers.
